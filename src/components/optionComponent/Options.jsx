...
const Options = () => {
    ...
    const handleOptionClick = (id) => {
      setOptionActiveId(id); // Update the active option ID
                ...
                <div key={`option${i + 1}`}>
                  <section
                    className={`Options-section ${
                      optionActiveId === opt.id && "option-active"
                    }`}
                    onClick={() => handleOptionClick(opt.id)} // Handle click on the option
                  >
                    <Option
                      optionVal={opt.score}
                      text={opt.option}
